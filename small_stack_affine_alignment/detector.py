...
class FeaturesDetector(object):
    ...
    def __init__(self, detector_type_name, **kwargs):
        ...
        if detector_type == FeaturesDetector.Type.SIFT:
            ...
            self._matcher_init_fn = lambda: cv2.BFMatcher(cv2.NORM_L2)
            ...
            self._matcher_init_fn = lambda: cv2.BFMatcher(cv2.NORM_HAMMING)
    ...
    @property
    def matcher_init_fn(self):
        return self._matcher_init_fn
